...
public class ViewsController {
    ...
    @GetMapping(value = "/getProductByServiceCategoryId/{id}")
    public ResponseEntity<?> getAllProductByServiceCategoryId (@PathVariable Long id) {
        List<Product> products = productService.findProductByServiceCategory(id); 
        return new ResponseEntity<>(products, HttpStatus.OK);
    } 
