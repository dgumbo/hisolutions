package zw.co.hisolutions.core.common.basic.controllers.rest;
...
public abstract class BaseRestController<T extends BaseEntity> {
    ...
    public ResponseEntity<Resource<T>> getResource(@PathVariable Long id) {
...
//        System.out.println("\nT  B4 Save : " + entity.getContent() + "\n");
        ...
        try {
            entity = (T) getService().create( entity);
            ...
            // Logger.getLogger(T Controller.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public ResponseEntity<Results> delete(@PathVariable Long id) {
