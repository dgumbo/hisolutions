...
import zw.co.hisolutions.tutorials.core.entities.dao.ProductDao;
import zw.co.hisolutions.tutorials.core.services.ProductService;
import zw.co.hisolutions.tutorials.rest.controllers.ProductController;
...
public class ProductJpa implements ProductService {
    ...
    @Autowired
    public ProductJpa(ProductDao productDao) {
